...
ADMIN_ID = int(_admin_raw) if _admin_raw.lstrip("-").isdigit() else None
...
SOAT_UPDATE_INTERVAL = _safe_int_env("SOAT_UPDATE_INTERVAL", 300)
...
PRO_PRICE_MONTH = _safe_int_env("PRO_PRICE_MONTH", 29000)
...
SMS_PAYMENT_MATCH_MIN = _safe_int_env("SMS_PAYMENT_MATCH_MIN", 50)
SMS_PAYMENT_MATCH_MAX = _safe_int_env("SMS_PAYMENT_MATCH_MAX", 999)
...
SMS_PAYMENT_TTL_MINUTES = _safe_int_env("SMS_PAYMENT_TTL_MINUTES", 20)
